...
( response goes here) 
that aggregate functions need thier own select statment/sql query. This might have been mentioned before and I prorably forgot, but this assignment helped renforce that. I'll keep this in mind when joining tables
...
( response goes here) that aggregate functions need thier own select statment/sql quaery
